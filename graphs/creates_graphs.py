...
data1 = pd.read_csv('../experiment/2023.05.29/1608_qlearning_vanilla/train.csv')
data2 = pd.read_csv('../experiment/2023.05.29/1608_qlearning_vanilla/eval.csv')
data3 = pd.read_csv('../experiment/2023.05.29/1915_sarsa_vanilla/train1.csv')
data4 = pd.read_csv('../experiment/2023.05.29/1915_sarsa_vanilla/eval1.csv')
